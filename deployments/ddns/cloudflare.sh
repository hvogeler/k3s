...
auth_email="heiko.vogeler@hvo.de"                                       # The email used to login 'https://dash.cloudflare.com'
auth_method="token"                                 # Set to "global" for Global API Key or "token" for Scoped API Token
auth_key="H44Y6lECORFVJQK7oOc6jPGEG6V3SVKyYK4vWs4w"                                         # Your API Token or Global API Key
zone_identifier="d384373cd94754b3b3bddfd172d7aa56"                                  # Can be found in the "Overview" tab of your domain
record_name="homelab.vogeler.cc"                                      # Which record you want to be synced
ttl=3600                                            # Set the DNS TTL (seconds)
proxy="false"                                       # Set the proxy to true or false
sitename="homelab"                                         # Title of site "Example Site"
